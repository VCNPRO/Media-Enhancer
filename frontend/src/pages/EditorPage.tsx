      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Nuevo Proyecto</span>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-4 gap-6 h-[calc(100vh-180px)]">
          ...
          <div className="lg:col-span-1 bg-gray-800 rounded-lg p-4">
            ...
            <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-400 mb-2">Arrastra archivos aquí</p>
          ...
          <div className="lg:col-span-1 bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-4 text-gray-400">
              <p className="text-sm">Selecciona un archivo para ver propiedades</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-gray-800 rounded-lg p-4">
          ...
          <div className="bg-gray-700 h-32 rounded-lg flex items-center justify-center text-gray-500">
            <p>Arrastra medios aquí para comenzar a editar</p>
          </div>
        </div>
      </main>
    </div>
